...
class CrossEntropyLossWrapper(L.CrossEntropyLoss):
    ...
    def __init__(self, digit_aware_weight_coef: Optional[float] = None, n_digits: Optional[int] = None,
        ...
        self.digit_aware_weight_coef = digit_aware_weight_coef
    ...
    def forward(self, input_code_probabilities: torch.Tensor, target_codes: torch.Tensor, eps=1E-15) -> torch.Tensor:
        ...
        if self.digit_aware_weight_coef is not None:
    ...
    def summary(self):
        ret = {
            ...
            "digit_aware_weight_coef": self.digit_aware_weight_coef,
