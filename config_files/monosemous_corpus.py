...
cfg_training = {
    "wikitext103-subset": {
        "path":pick_first_available_path(
            os.path.join(DIR_TRAIN_UNSUPERVISED_LOCAL, "bert-large-cased_wikitext103_train_freq=10-11_len=6-128.hdf5"),
            os.path.join(DIR_TRAIN_UNSUPERVISED, "bert-large-cased_wikitext103_train_freq=10-11_len=6-128.hdf5"),
        ),
        "padding": False,
    ...
    "wiki40b-all-wide-vocab": {
        "path":pick_first_available_path(
            os.path.join(DIR_TRAIN_UNSUPERVISED_LOCAL, "bert-large-cased_wiki40b-train-all-paragraph_freq=5-200_len=6-128.hdf5"),
            os.path.join(DIR_TRAIN_UNSUPERVISED, "bert-large-cased_wiki40b-train-all-paragraph_freq=5-200_len=6-128.hdf5"),
        ),
        "padding": False,
        "max_sequence_length": None,
    ...
    "wiki40b-all-narrow-vocab": {
        "path":pick_first_available_path(
            os.path.join(DIR_TRAIN_UNSUPERVISED_LOCAL, "bert-large-cased_wiki40b-train-all-paragraph_freq=100-300_len=6-128.hdf5"),
            os.path.join(DIR_TRAIN_UNSUPERVISED, "bert-large-cased_wiki40b-train-all-paragraph_freq=100-300_len=6-128.hdf5"),
        ),
        "padding": False,
        "max_sequence_length": None,
